...
#define __SPI_Read_Data(__BUFFER__, __SIZE__)     HAL_SPI_Receive(&SPI_Handle_Nor, __BUFFER__, __SIZE__, 0)

#define __SPI_Write_Data(__BUFFER__, __SIZE__)    HAL_SPI_Transmit(&SPI_Handle_Nor, __BUFFER__, __SIZE__, 0)
