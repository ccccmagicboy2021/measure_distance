...
#ifndef __PT32x030_UART_H
#define __PT32x030_UART_H
...
#define IS_UART_DUTYCYCLE(DUTYCYCLE)   ((DUTYCYCLE) <= 0x000FFF)
...
/** @defgroup USART_Flags 
  * @{
  */
#define  UART_FLAG_RXNE                      UART_SR_RXNE          /*!< Receiver FIFO buffer non-empty */
#define  UART_FLAG_RXHF                      UART_SR_RXHF          /*!< Receiver FIFO buffer half-full */
#define  UART_FLAG_RXF                       UART_SR_RXF           /*!< Receiver FIFO buffer full */
#define  UART_FLAG_TONE                      UART_SR_TONE          /*!< Receiver FIFO buffer cleared timeout  */
#define  UART_FLAG_TOIDLE                    UART_SR_TOIDLE        /*!< Receiver FIFO buffer idel */
#define  UART_FLAG_PERR                      UART_SR_PERR          /*!< Parity error */      
#define  UART_FLAG_FERR                      UART_SR_FERR          /*!< Frame error */
#define  UART_FLAG_OVERR                     UART_SR_OVERR         /*!< Receiver FIFO buffer overflow */    
#define  UART_FLAG_TXE                       UART_SR_TXE           /*!< Transmitter FIFO buffer empty */         
#define  UART_FLAG_TXHE                      UART_SR_TXHE          /*!< Transmitter FIFO buffer half-empty */       
#define  UART_FLAG_TXF                       UART_SR_TXF           /*!< Transmitter FIFO buffer full */   
#define  UART_FLAG_TXEND                     UART_SR_TXEND         /*!< Transfer completed */
...
#define  UART_CLEAR_FLAG_PERR                      UART_SR_PERR            /*!< Parity error */      
#define  UART_CLEAR_FLAG_FERR                      UART_SR_FERR            /*!< Frame error */
#define  UART_CLEAR_FLAG_OVERR                     UART_SR_OVERR           /*!< Receiver FIFO buffer overflow */ 
