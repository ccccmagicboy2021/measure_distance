...
#ifndef PT32X030_SPI_H
#define PT32X030_SPI_H
...
typedef struct
{
  ...
  uint16_t SPI_Mode;                /*!< Specifies the SPI mode (Master/Slave).This parameter can be a value of @ref SPI_mode */
  uint16_t SPI_DataSize;            /*!< Specifies the SPI data size. This parameter can be a value of @ref SPI_data_size */
  ...
  uint16_t SPI_NSS;                 /*!< Specifies whether the NSS signal is managed by hardware (NSS pin) or by software using the SSI bit. This parameter can be a value of @ref SPI_Slave_Select_management */
...
#define SPI_NSS_Soft                    SPI_CSCR_SWSEL
...
#define IS_SPI_BAUDRATE_POSTPRESCALER(POSTPRESCALER) ( 1<=( POSTPRESCALER &0x00FF00 )<=255 )

/** @defgroup SPI_NSS_internal_software_management  **/
#define SPI_NSSInternalSoft_Set         SPI_CSCR_SWCS
...
#define	SPI_CS_LOW()	SPI_NSSInternalSoftwareConfig(SPI0, SPI_NSSInternalSoft_Reset)
#define	SPI_CS_HIGH()	SPI_NSSInternalSoftwareConfig(SPI0, SPI_NSSInternalSoft_Set)
