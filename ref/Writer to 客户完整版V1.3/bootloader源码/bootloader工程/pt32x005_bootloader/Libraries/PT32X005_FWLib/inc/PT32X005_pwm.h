...
#define IS_PWM_CM(MODE)                      (((MODE) == CHAN_CAPTURE_RiseEdage_SEL)     || ((MODE) == CHAN_CAPTURE_FallingEdage_SEL) || \
        ((MODE) == CHAN_CAPTURE_ResetTC_SEL) || ((MODE) == (CHAN_CAPTURE_FallingEdage_SEL | CHAN_CAPTURE_RiseEdage_SEL)) )
