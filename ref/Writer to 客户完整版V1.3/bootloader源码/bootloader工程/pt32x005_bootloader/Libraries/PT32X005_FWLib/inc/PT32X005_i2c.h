...
#define I2C_SCLK_DIVX960                 ((uint32_t)0x00800000)
#define I2C_SCLK_DIVX256                 ((uint32_t)0x00000000)
#define I2C_SCLK_DIVX244                 ((uint32_t)0x00010000)
#define I2C_SCLK_DIVX192                 ((uint32_t)0x00020000)
#define I2C_SCLK_DIVX160                 ((uint32_t)0x00030000)
#define I2C_SCLK_DIVX120                 ((uint32_t)0x00810000)
#define I2C_SCLK_DIVX60                  ((uint32_t)0x00820000)
#define IS_SCLK_DIV(DIV)                 (((DIV) >= 4)  && ((DIV) < 1024))
