...
#include "core_cm0.h"
#include "PT32L03x_Type.h"
#include "system_PT32L03x.h"
#include <stdint.h>
...
typedef struct
{
	...
	__IO uint32_t  PID4;                 /*!< Offset: 0xFD0 PID0 Register (R/W) */
	__IO uint32_t  PID5;                 /*!< Offset: 0xFD4 PID1 Register (R/W) */
	__IO uint32_t  PID6;                 /*!< Offset: 0xFD8 PID2 Register (R/W) */
	__IO uint32_t  PID7;                 /*!< Offset: 0xFDC PID3 Register (R/W) */
	__IO uint32_t  PID0;                 /*!< Offset: 0xFE0 PID4 Register (R/W) */
	__IO uint32_t  PID1;                 /*!< Offset: 0xFE4 PID5 Register (R/W) */
	__IO uint32_t  PID2;                 /*!< Offset: 0xFE8 PID6 Register (R/W) */
	__IO uint32_t  PID3;                 /*!< Offset: 0xFEC PID7 Register (R/W) */
...
typedef struct
{
	...
	__IO uint32_t  ALTFUNCSET1;	/*!< Offset: 0x014 Alternate Function Set Register0  (R/W) */
...
typedef struct	//新增
{
	...
	__IO uint32_t STA;   		/*!< offset: 0x004 STATUS Register  (R/W)         */
	__IO uint32_t LOCK;  		/*!< offset: 0x008 Calendar lock Register           (R/W)         */
	__IO uint32_t SEC;          	/*!< offset: 0x00C SEC Register   (R/W)         */
	__IO uint32_t MIN;         	/*!< offset: 0x010 MIN Register      (R/W)         */
	__IO uint32_t HOUR;        	/*!< offset: 0x014 HOUR Register      (R/W)         */
	__IO uint32_t DAY;       	/*!< offset: 0x018 DAY Register       (R/W)         */
	__IO uint32_t WEEK;       	/*!< offset: 0x01C WEEK Register       (R/W)         */
	__IO uint32_t MONTH;     	/*!< offset: 0x020 MONTH Register       (R/W)         */
	__IO uint32_t YEAR;        	/*!< offset: 0x024 YEAR Register       (R/W)         */
	__IO uint32_t IE;            	/*!< offset: 0x028 Interrupt Enable Register       (R/W)         */
	__IO uint32_t IF;           	/*!< offset: 0x02C Interrupt Flag Register       (R/W)         */
	__IO uint32_t ALM_SEC;	/*!< offset: 0x030 Alarm SEC Register       (R/W)         */
	__IO uint32_t ALM_MIN;	/*!< offset: 0x034 Alarm MIN Register       (R/W)         */
	__IO uint32_t ALM_HOUR;	/*!< offset: 0x038 Alarm HOUR Register       (R/W)         */
	__IO uint32_t CALR;      	/*!< offset: 0x03C Compensate Register       (R/W)         */
} CMSDK_RTC_TypeDef;
...
//	__IO uint32_t GSEL;   		/*!< offset: 0x004 Gray SET Register  (R/W)         */
//	__IO uint32_t FSEL;  		/*!< offset: 0x008 Display Frequency Control Register  (R/W)         */
//	__IO uint32_t BTIME;          	/*!< offset: 0x00C Flashing Period Control Register   (R/W)         */
//	__IO uint32_t BON;         	/*!< offset: 0x010 Flashing Light up Time Control Register      (R/W)         */
//	__IO uint32_t PEN;        	/*!< offset: 0x014 Pin Enable Register      (R/W)         */
//	uint32_t  	RESERVED0;		/*!< Offset: 0x018 RESERVED0*/
//	__IO uint32_t SCSEL;       	/*!< offset: 0x01C  SEG/COM Select Register       (R/W)         */
//	uint32_t  	RESERVED1;		/*!< Offset: 0x020 RESERVED1*/
//	__IO uint32_t PGPERIOD;	/*!< offset: 0x024 Page Display Time Register       (R/W)         */
//	__IO uint32_t PGMAX;     	/*!< offset: 0x028 Maximum number of pages in rotation Register       (R/W)         */
//	__IO uint32_t PGCNT;        	/*!< offset: 0x02C Current Carousel Display Page Register       (R/W)         */
//	__IO uint32_t LCD_TRIM_CON;	/*!< offset: 0x030 Module internal clock correction Register       (R/W)         */
//	__IO uint32_t ANA_TRIM_CON;	/*!< offset: 0x034 Module calibration parameter configuration Register       (R/W)         */
//} CMSDK_LCD_TypeDef;
...
//typedef struct	//新增
//{
//	__IO uint32_t LCD_DATA_P0_3_0;		/*!< Offset: 0x000*/  
//	__IO uint32_t LCD_DATA_P0_7_4;		/*!< Offset: 0x004*/  
//	__IO uint32_t LCD_DATA_P0_11_8;		/*!< Offset: 0x008*/  
//	__IO uint32_t LCD_DATA_P0_15_12;	/*!< Offset: 0x00C*/  
//	__IO uint32_t LCD_DATA_P0_19_16;	/*!< Offset: 0x010*/  
//	__IO uint32_t LCD_DATA_P0_23_20;	/*!< Offset: 0x014*/  	
//	__IO uint32_t LCD_DATA_P0_27_24;	/*!< Offset: 0x018*/  
//	__IO uint32_t LCD_DATA_P0_31_28;	/*!< Offset: 0x01C*/  
//	
//	__IO uint32_t LCD_DATA_P1_3_0;		/*!< Offset: 0x020*/  
//	__IO uint32_t LCD_DATA_P1_7_4;		/*!< Offset: 0x024*/  
//	__IO uint32_t LCD_DATA_P1_11_8;		/*!< Offset: 0x028*/  
//	__IO uint32_t LCD_DATA_P1_15_12;	/*!< Offset: 0x02C*/  
//	__IO uint32_t LCD_DATA_P1_19_16;	/*!< Offset: 0x030*/  
//	__IO uint32_t LCD_DATA_P1_23_20;	/*!< Offset: 0x034*/  
//	__IO uint32_t LCD_DATA_P1_27_24;	/*!< Offset: 0x038*/  
//	__IO uint32_t LCD_DATA_P1_31_28;	/*!< Offset: 0x03C*/  
//	
//	__IO uint32_t LCD_DATA_P2_3_0;		/*!< Offset: 0x040*/  
//	__IO uint32_t LCD_DATA_P2_7_4;		/*!< Offset: 0x044*/  
//	__IO uint32_t LCD_DATA_P2_11_8;		/*!< Offset: 0x048*/  
//	__IO uint32_t LCD_DATA_P2_15_12;	/*!< Offset: 0x04C*/  
//	__IO uint32_t LCD_DATA_P2_19_16;	/*!< Offset: 0x050*/  
//	__IO uint32_t LCD_DATA_P2_23_20;	/*!< Offset: 0x054*/  	
//	__IO uint32_t LCD_DATA_P2_27_24;	/*!< Offset: 0x058*/  
//	__IO uint32_t LCD_DATA_P2_31_28;	/*!< Offset: 0x05C*/  
//	
//	__IO uint32_t LCD_DATA_P3_3_0;		/*!< Offset: 0x060*/  
//	__IO uint32_t LCD_DATA_P3_7_4;		/*!< Offset: 0x064*/  
//	__IO uint32_t LCD_DATA_P3_11_8;		/*!< Offset: 0x068*/  
//	__IO uint32_t LCD_DATA_P3_15_12;	/*!< Offset: 0x06C*/  
//	__IO uint32_t LCD_DATA_P3_19_16;	/*!< Offset: 0x070*/  
//	__IO uint32_t LCD_DATA_P3_23_20;	/*!< Offset: 0x074*/  	
//	__IO uint32_t LCD_DATA_P3_27_24;	/*!< Offset: 0x078*/  
//	__IO uint32_t LCD_DATA_P3_31_28;	/*!< Offset: 0x07C*/  
//	
//	__IO uint32_t LCD_DATA_P4_3_0;		/*!< Offset: 0x080*/  
//	__IO uint32_t LCD_DATA_P4_7_4;		/*!< Offset: 0x084*/  
//	__IO uint32_t LCD_DATA_P4_11_8;		/*!< Offset: 0x088*/  
//	__IO uint32_t LCD_DATA_P4_15_12;	/*!< Offset: 0x08C*/  
//	__IO uint32_t LCD_DATA_P4_19_16;	/*!< Offset: 0x090*/  
//	__IO uint32_t LCD_DATA_P4_23_20;	/*!< Offset: 0x094*/  	
//	__IO uint32_t LCD_DATA_P4_27_24;	/*!< Offset: 0x098*/  
//	__IO uint32_t LCD_DATA_P4_31_28;	/*!< Offset: 0x09C*/  
//	
//	__IO uint32_t LCD_DATA_P5_3_0;		/*!< Offset: 0x0A0*/  
//	__IO uint32_t LCD_DATA_P5_7_4;		/*!< Offset: 0x0A4*/  
//	__IO uint32_t LCD_DATA_P5_11_8;		/*!< Offset: 0x0A8*/  
//	__IO uint32_t LCD_DATA_P5_15_12;	/*!< Offset: 0x0AC*/  
//	__IO uint32_t LCD_DATA_P5_19_16;	/*!< Offset: 0x0B0*/  
//	__IO uint32_t LCD_DATA_P5_23_20;	/*!< Offset: 0x0B4*/  	
//	__IO uint32_t LCD_DATA_P5_27_24;	/*!< Offset: 0x0B8*/  
//	__IO uint32_t LCD_DATA_P5_31_28;	/*!< Offset: 0x0BC*/  

//	__IO uint32_t LCD_DATA_P6_3_0;		/*!< Offset: 0x0C0*/  
//	__IO uint32_t LCD_DATA_P6_7_4;		/*!< Offset: 0x0C4*/  
//	__IO uint32_t LCD_DATA_P6_11_8;		/*!< Offset: 0x0C8*/  
//	__IO uint32_t LCD_DATA_P6_15_12;	/*!< Offset: 0x0CC*/  
//	__IO uint32_t LCD_DATA_P6_19_16;	/*!< Offset: 0x0D0*/  
//	__IO uint32_t LCD_DATA_P6_23_20;	/*!< Offset: 0x0D4*/  	
//	__IO uint32_t LCD_DATA_P6_27_24;	/*!< Offset: 0x0D8*/  
//	__IO uint32_t LCD_DATA_P6_31_28;	/*!< Offset: 0x0DC*/  

//	__IO uint32_t LCD_DATA_P7_3_0;		/*!< Offset: 0x0E0*/  
//	__IO uint32_t LCD_DATA_P7_7_4;		/*!< Offset: 0x0E4*/  
//	__IO uint32_t LCD_DATA_P7_11_8;		/*!< Offset: 0x0E8*/  
//	__IO uint32_t LCD_DATA_P7_15_12;	/*!< Offset: 0x0EC*/  
//	__IO uint32_t LCD_DATA_P7_19_16;	/*!< Offset: 0x0F0*/  
//	__IO uint32_t LCD_DATA_P7_23_20;	/*!< Offset: 0x0F4*/  	
//	__IO uint32_t LCD_DATA_P7_27_24;	/*!< Offset: 0x0F8*/  
//	__IO uint32_t LCD_DATA_P7_31_28;	/*!< Offset: 0x0FC*/  

//	__IO uint32_t LCD_DATA_P8_3_0;		/*!< Offset: 0x100*/  
//	__IO uint32_t LCD_DATA_P8_7_4;		/*!< Offset: 0x104*/  
//	__IO uint32_t LCD_DATA_P8_11_8;		/*!< Offset: 0x108*/  
//	__IO uint32_t LCD_DATA_P8_15_12;	/*!< Offset: 0x10C*/  
//	__IO uint32_t LCD_DATA_P8_19_16;	/*!< Offset: 0x110*/  
//	__IO uint32_t LCD_DATA_P8_23_20;	/*!< Offset: 0x114*/  	
//	__IO uint32_t LCD_DATA_P8_27_24;	/*!< Offset: 0x118*/  
//	__IO uint32_t LCD_DATA_P8_31_28;	/*!< Offset: 0x11C*/  

//	__IO uint32_t LCD_DATA_P9_3_0;		/*!< Offset: 0x120*/  
//	__IO uint32_t LCD_DATA_P9_7_4;		/*!< Offset: 0x124*/  
//	__IO uint32_t LCD_DATA_P9_11_8;		/*!< Offset: 0x128*/  
//	__IO uint32_t LCD_DATA_P9_15_12;	/*!< Offset: 0x12C*/  
//	__IO uint32_t LCD_DATA_P9_19_16;	/*!< Offset: 0x130*/  
//	__IO uint32_t LCD_DATA_P9_23_20;	/*!< Offset: 0x134*/  	
//	__IO uint32_t LCD_DATA_P9_27_24;	/*!< Offset: 0x138*/  
//	__IO uint32_t LCD_DATA_P9_31_28;	/*!< Offset: 0x13C*/  
//	
//	__IO uint32_t LCD_DATA_P10_3_0;		/*!< Offset: 0x140*/  
//	__IO uint32_t LCD_DATA_P10_7_4;		/*!< Offset: 0x144*/  
//	__IO uint32_t LCD_DATA_P10_11_8;	/*!< Offset: 0x148*/  
//	__IO uint32_t LCD_DATA_P10_15_12;	/*!< Offset: 0x14C*/  
//	__IO uint32_t LCD_DATA_P10_19_16;	/*!< Offset: 0x150*/  
//	__IO uint32_t LCD_DATA_P10_23_20;	/*!< Offset: 0x154*/  	
//	__IO uint32_t LCD_DATA_P10_27_24;	/*!< Offset: 0x158*/  
//	__IO uint32_t LCD_DATA_P10_31_28;	/*!< Offset: 0x15C*/  
//	
//	__IO uint32_t LCD_DATA_P11_3_0;		/*!< Offset: 0x160*/  
//	__IO uint32_t LCD_DATA_P11_7_4;		/*!< Offset: 0x164*/  
//	__IO uint32_t LCD_DATA_P11_11_8;	/*!< Offset: 0x168*/  
//	__IO uint32_t LCD_DATA_P11_15_12;	/*!< Offset: 0x16C*/  
//	__IO uint32_t LCD_DATA_P11_19_16;	/*!< Offset: 0x170*/  
//	__IO uint32_t LCD_DATA_P11_23_20;	/*!< Offset: 0x174*/  	
//	__IO uint32_t LCD_DATA_P11_27_24;	/*!< Offset: 0x178*/  
//	__IO uint32_t LCD_DATA_P11_31_28;	/*!< Offset: 0x17C*/  
//	
//	__IO uint32_t LCD_DATA_P12_3_0;		/*!< Offset: 0x180*/  
//	__IO uint32_t LCD_DATA_P12_7_4;		/*!< Offset: 0x184*/  
//	__IO uint32_t LCD_DATA_P12_11_8;	/*!< Offset: 0x188*/  
//	__IO uint32_t LCD_DATA_P12_15_12;	/*!< Offset: 0x18C*/  
//	__IO uint32_t LCD_DATA_P12_19_16;	/*!< Offset: 0x190*/  
//	__IO uint32_t LCD_DATA_P12_23_20;	/*!< Offset: 0x194*/  	
//	__IO uint32_t LCD_DATA_P12_27_24;	/*!< Offset: 0x198*/  
//	__IO uint32_t LCD_DATA_P12_31_28;	/*!< Offset: 0x19C*/  
//	
//	__IO uint32_t LCD_DATA_P13_3_0;		/*!< Offset: 0x1A0*/  
//	__IO uint32_t LCD_DATA_P13_7_4;		/*!< Offset: 0x1A4*/  
//	__IO uint32_t LCD_DATA_P13_11_8;	/*!< Offset: 0x1A8*/  
//	__IO uint32_t LCD_DATA_P13_15_12;	/*!< Offset: 0x1AC*/  
//	__IO uint32_t LCD_DATA_P13_19_16;	/*!< Offset: 0x1B0*/  
//	__IO uint32_t LCD_DATA_P13_23_20;	/*!< Offset: 0x1B4*/  	
//	__IO uint32_t LCD_DATA_P13_27_24;	/*!< Offset: 0x1B8*/  
//	__IO uint32_t LCD_DATA_P13_31_28;	/*!< Offset: 0x1BC*/  

//	__IO uint32_t LCD_DATA_P14_3_0;		/*!< Offset: 0x1C0*/  
//	__IO uint32_t LCD_DATA_P14_7_4;		/*!< Offset: 0x1C4*/  
//	__IO uint32_t LCD_DATA_P14_11_8;	/*!< Offset: 0x1C8*/  
//	__IO uint32_t LCD_DATA_P14_15_12;	/*!< Offset: 0x1CC*/  
//	__IO uint32_t LCD_DATA_P14_19_16;	/*!< Offset: 0x1D0*/  
//	__IO uint32_t LCD_DATA_P14_23_20;	/*!< Offset: 0x1D4*/  	
//	__IO uint32_t LCD_DATA_P14_27_24;	/*!< Offset: 0x1D8*/  
//	__IO uint32_t LCD_DATA_P14_31_28;	/*!< Offset: 0x1DC*/  

//	__IO uint32_t LCD_DATA_P15_3_0;		/*!< Offset: 0x1E0*/  
//	__IO uint32_t LCD_DATA_P15_7_4;		/*!< Offset: 0x1E4*/  
//	__IO uint32_t LCD_DATA_P15_11_8;	/*!< Offset: 0x1E8*/  
//	__IO uint32_t LCD_DATA_P15_15_12;	/*!< Offset: 0x1EC*/  
//	__IO uint32_t LCD_DATA_P15_19_16;	/*!< Offset: 0x1F0*/  
//	__IO uint32_t LCD_DATA_P15_23_20;	/*!< Offset: 0x1F4*/  	
//	__IO uint32_t LCD_DATA_P15_27_24;	/*!< Offset: 0x1F8*/  
//	__IO uint32_t LCD_DATA_P15_31_28;	/*!< Offset: 0x1FC*/  
//} CMSDK_LCD_DATA_TypeDef;
...
//typedef struct
//{
//	__IO uint32_t CTRL;       	/*!< Offset: 0x000 ADC Control register */
//	__IO uint32_t DAT;    	/*!< Offset: 0x004 ADC Status Register  (R/W) */
//	__IO uint32_t IE;    	/*!< Offset: 0x008 ADC data register (R/W) */
//	__IO uint32_t STAT;	/*!< Offset: 0x00C ADC SAMPLE TIMER register (R/W) */
//} CMSDK_DAC_TypeDef;	
...
//	__IO uint32_t COMP_DAC;       /*!< 5Bit DAC data register                               Address offset: 0x08 */
...
typedef struct 
{
	...
	__IO uint32_t IOSC_8M_CON;	/*!< Offset: 0x010 24MHZ IOSC Control Register (R/W) */
	...
	__IO uint32_t IOSC_32K_CON1;	/*!< Offset: 0x028 32KHZ IOSC Control Register 1 (R/W) */
	__IO uint32_t IOSC_32K_CON2;	/*!< Offset: 0x02C 32KHZ IOSC Control Register 2 (R/W) */
	__IO uint32_t VREF2V_CON;	/*!< Offset: 0x030 32KHZ IOSC Control Register 2 (R/W) */
...
#define CMSDK_SPI1_BASE             	(CMSDK_APB_BASE + 0x0000D800)
...
#define CMPOPA_CR1_12BITDAC			((uint32_t)0x0000000C)
...
#define CMPOPA_CR2_VG		((uint32_t)0x00008000)          /*!< VG PIN Mode Config*/
