...
#ifndef PT32L03x_GPIO_H
#define PT32L03x_GPIO_H
...
#define IS_GPIO_MODE(MODE) (((MODE) == GPIO_Mode_IN)|| ((MODE) == GPIO_OType_PP) || ((MODE) == GPIO_OType_OD)|| ((MODE) == GPIO_Mode_AN))
...
#define IS_GPIO_ALL_PERIPH(PERIPH) (((PERIPH) == CMSDK_PA) || ((PERIPH) == CMSDK_PB) || ((PERIPH) == CMSDK_PC) || ((PERIPH) == CMSDK_PD))
...
#define GPIO_AF_0            ((uint8_t)0x01)	/** @brief  AF 0 selection **/
#define GPIO_AF_1            ((uint8_t)0x02)	/** @brief  AF 1 selection **/
#define GPIO_AF_2            ((uint8_t)0x03)	/**@brief   AF 2 selection **/
#define GPIO_AF_3            ((uint8_t)0x04)	/** @brief  AF 3 selection **/
#define GPIO_AF_4            ((uint8_t)0x05)	/** @brief  AF 4 selection **/
#define GPIO_AF_5            ((uint8_t)0x06)	/** @brief  AF 5 selection **/
#define GPIO_AF_6            ((uint8_t)0x06)	/** @brief  AF 6 selection **/
#define IS_GPIO_AF(AF)   (((AF) == GPIO_AF_0) || ((AF) == GPIO_AF_1) ||  ((AF) == GPIO_AF_2) || ((AF) == GPIO_AF_3) || \
                          			((AF) == GPIO_AF_4) || ((AF) == GPIO_AF_5) || ((AF) == GPIO_AF_6))
