...
#ifndef __PT32x030_GPIO_H
#define __PT32x030_GPIO_H
...
#define GPIO_IT_ITE0                          GPIO_INTENSET_IES0                  /*!< Port interrupt enable bit set, bit 0 */   
#define GPIO_IT_ITE1                          GPIO_INTENSET_IES1                  /*!< Port interrupt enable bit set, bit 1 */   
#define GPIO_IT_ITE2                          GPIO_INTENSET_IES2                  /*!< Port interrupt enable bit set, bit 2 */   
#define GPIO_IT_ITE3                          GPIO_INTENSET_IES3                  /*!< Port interrupt enable bit set, bit 3 */   
#define GPIO_IT_ITE4                          GPIO_INTENSET_IES4                  /*!< Port interrupt enable bit set, bit 4 */   
#define GPIO_IT_ITE5                          GPIO_INTENSET_IES5                  /*!< Port interrupt enable bit set, bit 5 */   
#define GPIO_IT_ITE6                          GPIO_INTENSET_IES6                  /*!< Port interrupt enable bit set, bit 6 */   
#define GPIO_IT_ITE7                          GPIO_INTENSET_IES7                  /*!< Port interrupt enable bit set, bit 7 */   
#define GPIO_IT_ITE8                          GPIO_INTENSET_IES8                  /*!< Port interrupt enable bit set, bit 8 */   
#define GPIO_IT_ITE9                          GPIO_INTENSET_IES9                  /*!< Port interrupt enable bit set, bit 9 */   
#define GPIO_IT_ITE10                         GPIO_INTENSET_IES10                 /*!< Port interrupt enable bit set, bit 10 */  
#define GPIO_IT_ITE11                         GPIO_INTENSET_IES11                 /*!< Port interrupt enable bit set, bit 11 */  
#define GPIO_IT_ITE12                         GPIO_INTENSET_IES12                 /*!< Port interrupt enable bit set, bit 12 */  
#define GPIO_IT_ITE13                         GPIO_INTENSET_IES13                 /*!< Port interrupt enable bit set, bit 13 */  
#define GPIO_IT_ITE14                         GPIO_INTENSET_IES14                 /*!< Port interrupt enable bit set, bit 14 */  
#define GPIO_IT_ITE15                         GPIO_INTENSET_IES15                 /*!< Port interrupt enable bit set, bit 15 */ 
