...
#define RT_SH_FAIL               0x06 //烧写失调值到flash失败
#define RT_NOMT_FAIL             0x07 //组合方案未进行模组测试
#define RT_MT_FAIL               0x08 //组合方案模组测式结果失败
#define RT_KEY_BASE_FAIL         0x09 //按键基线软件设置失败
#define RT_FG_BASE_FAIL          0x0a //手指基线软件设置失败
#define RT_FG_BASE_ERROR         0x0b //手指基线错误
#define RT_SFR_BAK_FAIL          0x0c //写备份寄存器出错
#define RT_EXCEPTION_FAIL        0x0d //发生异常
#define RT_FG_CFG_FAIL           0x0e //修改手指配置字出错
#define RT_SFR_CHECK_ERROR       0x80 //sfr校验出错
#define RT_COVER	               0xc5 //有覆盖物
...
#define CHIP_TESTMODE                   0x22//模组测试工作模式
