...
//写入的FLASH起始地址与结束地址
#define WRITE_START_ADDR  ((uint32_t)0x00240200)
#define WRITE_END_ADDR    ((uint32_t)0x002403FF)
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
...
int InternalFlash_Test(void)
{
	...
	uint32_t Data0 = 0x12345678;			//记录写入的数据
	uint32_t Data1 = 0x98765432;	    //记录写入的数据
