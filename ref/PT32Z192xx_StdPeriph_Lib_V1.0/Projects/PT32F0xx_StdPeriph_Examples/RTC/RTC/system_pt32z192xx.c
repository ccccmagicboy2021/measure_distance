...
#define IOSC_24M_ENABLE               (0)     /*!< 0: DISABLE,  1: ENABLE                                        */
...
#define PLL_CLK_SRC                   (1)     /*!< 0: IOCS_24M, 1: EXT_CLK                                       */
...
//	CMSDK_ANAMIX ->PLL_CON= 0;	
   ...
   CMSDK_PC->ALTFUNCSET |= (1<<28); //PC14/PC15
   CMSDK_PC->ALTFUNCSET |= (1<<30);
   ...
   Wait_ClockReady();
	 ...
	 CMSDK_SYSCON ->SYSCLK = ((CMSDK_SYSCON ->SYSCLK & 0xFFFC) | HCLK_SRC) ;    //HCLK_SROUCE
