...
void init_timer(void)
{
    ...
    TIM_OCInitStructure.OutputState = TIM_OUTPUT_STATE_ENABLE;
    TIM_OCInitStructure.Pulse       = 5 - 1;        //2.5us
    //TIM_OCInitStructure.Pulse       = 10 - 1;        //5us
    //TIM_OCInitStructure.Pulse       = 20 - 1;        //10us
    ...
    TIM_OCInitStructure.OcMode      = TIM_OCMODE_PWM1;
    TIM_OCInitStructure.OutputState = TIM_OUTPUT_STATE_ENABLE;
    TIM_OCInitStructure.Pulse       = 10 - 1;   //1%        //5us
    //TIM_OCInitStructure.Pulse       = 20 - 1;   //2%        //10us
    //TIM_OCInitStructure.Pulse       = 40 - 1;   //4%        //20us
