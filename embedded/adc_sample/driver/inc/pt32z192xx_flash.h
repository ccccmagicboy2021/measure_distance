...
/** @defgroup FLASH_Address 
  * @{
  */
#if defined(PT32Z192)     /*512K devices */
...
#define NVR_START_ADDR       ((uint32_t)0x00240000)
#define NVR_END_ADDR         ((uint32_t)0x002403FF)



#define IS_FLASH_PROGRAM_ADDRESS(ADDRESS)   (((ADDRESS) <= MAINCODE_END_ADDR)) ||(((ADDRESS) <= NVR_END_ADDR)&&((ADDRESS) >= NVR_START_ADDR))
