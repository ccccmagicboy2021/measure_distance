...
//BT work state
//=============================================================================
#define         BT_UN_BIND                      0x00                            //Unbound state//蓝牙未绑定
#define         BT_NOT_CONNECTED                0x01                            //Bound but not connected蓝牙已绑定未连接
#define         BT_CONNECTED                    0x02                            //Bound and connected蓝牙已绑定并已连接
