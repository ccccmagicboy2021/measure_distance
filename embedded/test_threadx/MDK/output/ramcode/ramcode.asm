...
** Program header #0 (PT_LOAD) [PF_X + PF_W + PF_R + PF_ARM_ENTRY]
    Size : 36600 bytes (26400 bytes in file)
...
** Section #1 'ER_IROM1' (SHT_PROGBITS) [SHF_ALLOC + SHF_EXECINSTR]
    ...
    RESET
    __Vectors
        0x20000000:    200128e8    .(.     DCD    536946920
    ...
    __main
    _main_stk
        0x20000280:    f8dfd010    ....    LDR      sp,__lit__00000000 ; [0x20000294] = 0x200128e8
    ...
    __rt_final_cpp
    __rt_final_exit
        0x20000294:    200128e8    .(.     DCD    536946920
    $t
    .text
    $v0
    Reset_Handler
    ...
    _tx_initialize_low_level
        ...
        0x200002f8:    4915        .I      LDR      r1,[pc,#84] ; [0x20000350] = 0x200128e8
    ...
    $d
        ...
        0x20000350:    200128e8    .(.     DCD    536946920
    ...
    $d
        ...
        0x2000637c:    343a3031    10:4    DCD    876228657
        0x20006380:    32303a33    3:02    DCD    842021427
        0x20006384:    00000000    ....    DCD    0
        0x20006388:    206e614a    Jan     DCD    544104778
        0x2000638c:    32203131    11 2    DCD    840970545
